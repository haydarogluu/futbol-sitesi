<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hesapDmin.aspx.cs" Inherits="futbol_sitesi.hesapAdmin" MasterPageFile="~/Site2.Master" %>
  ...
  <div class="container" style ="margin-top:20px; color: white;">                    
    <div class="card row" style="background-color: rgba(31,33,34,0.95);">
      <div class="card-header">Futbolcu Ekle</div>
        ...
        <asp:Button runat="server" ID="btnFutEkle" Text="Futbolcu Ekleyin" CssClass="btn btn-danger" UseSubmitBehavior="False" OnClick="btnFutEkle_Click" />
      </div>
    </div>
    <div class="container" style ="margin-top:20px; color: white;">                    
      <div class="card row" style="background-color: rgba(31,33,34,0.95);">
